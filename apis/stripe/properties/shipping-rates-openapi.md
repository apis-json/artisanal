        ...
        content:
          application/x-www-form-urlencoded:
            ...
            schema:
              ...
              $ref: '#/components/schemas/GetShippingRatesRequest'
        required: false
      responses:
        '200':
          content:
            application/json:
              schema:
                ...
                x-expandableFields:
                  - data
                $ref: '#/components/schemas/ShippingResourcesShippingRateList'
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            ...
            schema:
              additionalProperties: false
              $ref: '#/components/schemas/PostShippingRatesRequest'
        required: true
      responses:
        '200':
          content:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            ...
            schema:
              additionalProperties: false
              $ref: '#/components/schemas/GetShippingRatesShippingRateTokenRequest'
        required: false
      responses:
        '200':
          content:
      ...
      requestBody:
        content:
          application/x-www-form-urlencoded:
            ...
            schema:
              additionalProperties: false
              $ref: '#/components/schemas/PostShippingRatesShippingRateTokenRequest'
        required: false
      responses:
        '200':
          content:
