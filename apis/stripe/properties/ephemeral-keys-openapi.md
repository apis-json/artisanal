          ...
          application/x-www-form-urlencoded:
            ...
            schema:
              ...
              properties:
                customer:
                  description: >-
                    The ID of the Customer you'd like to modify using the
                ...
                issuing_card:
                  description: >-
                    The ID of the Issuing Card you'd like to access using the
                    resulting ephemeral key.
                  maxLength: 5000
                  type: string
                nonce:
                ...
                verification_session:
                  description: >-
                    ...
                    access using the resulting ephemeral key
                  maxLength: 5000
                  type: string
              type: object
        required: false
